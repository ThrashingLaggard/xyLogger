...
namespace xyMessageFactory.Factories
{
    ...
    IEfCoreMessages, ISecurityMessages, IKeyHandlingMessages,
    ITokenHandlingMessages, INetworkMessages, IUserMessages,
    ILoginMessages, IKeyPressMessages, IWindowMessages, ISystemMessages, IBrowserAutomatizationMessages
        {
        ...
        public string EmptyIEnumerable(string? nameOfTheIEnumerable = null) => nameOfTheIEnumerable == null ? "The target IEnumerable is empty! Please check recent operations and logs!" : $"{nameOfTheIEnumerable} is EMPTY!";
            ...
            /// <returns></returns>
            public string SerializationSuccess(object? target = null) => target is null ? $"The target has been serialized!" : target.GetType().Name + "     :     "+ target +" has been serialized!";
        ...
        /// </summary>
        /// <returns></returns>
        public string WrongUserNameOrPassword(string? userName = null) => userName is null ? "Entered username or password is wrong, please correct input!" : "Entered username or password for" + userName + "is wrong, please correct input!";
            /// <summary>
            /// Username is wrong
            /// </summary>
            /// <returns></returns>
            public string WrongUserName(string? userName = null) => userName is null?"Entered username is wrong, please input correct username!": "Entered username " + userName + "is wrong, please input correct username!";
            /// <summary>
            /// Password is wrong
            /// </summary>
            /// <returns></returns>
            public string WrongPassword(string? userName = null) => userName is null ?  "Entered password is wrong, please input correct password!" :  "Entered password for "+userName+" is wrong, please input correct password!";
        ...
        /// <param name="ID"></param>
        /// <returns></returns>
        public string NotCreated([MaybeNull] int? ID = null) => ID == null ? "Failed to create the target! Please check your input!" : $"Failed to create  " + ID + "! Please check your input";
        /// <summary>
        /// Created target -> name
        /// </summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public string NotCreated([MaybeNull] string? name = null) => name == null ? "Failed to create the target! Please check your input!" : $"Failed to create the "+name+"! Please check your input";
            ...
            /// <param name="name"></param>
            /// <returns></returns>
            public string EntryUpdated([MaybeNull] string? name = null) => name == null ? $"Entry in DB-Context was updated successfully" : $"{name} was successfully updated in the context";
            /// <summary>
            ...
            /// </summary>
            /// <returns></returns>
            public string TokenNotGenerated(string? token = null) => token == null ? "Critical Failure in the token generation process!" : "Critical Failure in the generation process for the token: "+token ;
